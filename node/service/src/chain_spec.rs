...
/// The `ChainSpec` parametrised for the Venus runtime.
pub type VenusChainSpec = service::GenericChainSpec<westend::GenesisConfig, Extensions>;
...
pub fn venus_development_config() -> Result<VenusChainSpec, String> {
